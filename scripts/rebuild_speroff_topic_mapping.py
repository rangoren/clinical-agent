...
from services.textbook_catalog_service import build_gabbe_topic_mapping_summary, build_speroff_topic_mapping_batch


def main():
    parser = argparse.ArgumentParser(description="Incrementally build Speroff topic mapping.")
    ...
    while True:
        payload = build_speroff_topic_mapping_batch(offset=offset, limit=batch_size, tier=tier)
    ...
    cached = get_textbook_cache("speroff_10_topic_mapping") or {}
    summary = build_gabbe_topic_mapping_summary(cached.get("payload") or {})
